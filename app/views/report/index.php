...
//end format tanggal
    ...
    function createPDF() {  
        getCanvas().then(function (canvas) {  
            ...
            doc.save('Period Activity.pdf');  
            form.width(cache_width);  
        });  
    } 
    
    function getCanvas() {  
        //console.log((a4[0] * 1.33333) - 80);
        //1013.7046823999999
        form.width(1015.7046823999999).css('max-width', 'none');  
    ...
    $(document).on("click","#printExcel",function(){
          $("#tabelhead").table2excel({
            // exclude CSS class
            exclude: ".noExl",
            name: "Excel Period Activity",
            filename: "ExcelPeriodActivity", //do not include extension
