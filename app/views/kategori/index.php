  ...
  <section class="section">
      ...
      //reset delete
            ...
            function get_header(){
                ...
                <h4 class="text-center">Master Kategori </h4>
                </div></div>
                ...
                //   let substr_bulan = bulan.substr(0,3);
                    let dataTable =`
                                <table id="tabel1" class='display table-info' style='width:100%'>                    
                                                ...
                                                <tr>
                                                            <th style="width:2%">Kode Kategori</th>
                                                            <th style="width:3%">Nama Kategori</th>
            ...
            function member_div(div){
              getmember_Kategori(div);
                $("#data_id").val(div);
                $("#data_Kategori").hide();
                $("#member_Kategori").show();
