              ...
              <button type="button" class="btn-close" data-bs-dismiss="modal" id="close_edit" aria-label="Close"></button>
                      ...
                      <form  id ="formedit"  class ="form form-horizontal">
                        <div class="row col-md-12 mb-3">  
                                    <label for="kode_edit" class="col-sm-3 col-form-label">Kode Jabatan</label>
                                    <div class="col-sm-3">
                            ...
                            <div class="row col-md-12">  
                                    <label for="nama_edit" class="col-sm-3 col-form-label">Nama Jabatan</label>
                                    <div class="col-sm-6">
                                      <input type="text" class="form-control"  name="nama_edit" id="nama_edit" value="" required>
                                    </div>
                            </div>
                            <div class="row col-md-12 mb-3">  
                                      <label for="level_jabatan_edit" class="col-sm-3 col-form-label">Level</label>
                                      <div class="col-sm-3">
                                        <input type="number" class="form-control"  name="level_jabatan_edit" id="level_jabatan_edit" value="" required>
                                      </div>
                              </div>
                      </div>
...
<script>
    $(document).ready(function(){
                ...
                jQuery.each(columns, function(key, item) { 
                    switch(key){
                      ...
                      case 1:
                        ...
                        break;
                        case 2:
                        let level = item.innerHTML;
                        $(".modal-body #level_jabatan_edit").val(level);
                        break;
     ...
     //end edit data member Jabatan
     $("#Editdata").on("click",function(e){
                    e.preventDefault();
                  
                    let  kode = $("#kode_edit").val();
                    let  nama = $("#nama_edit").val();
                    let  level = $("#level_jabatan_edit").val();
                    $.ajax({
                        url:"<?= base_url; ?>/Jabatan/editdata",
                        type:'POST',
                        dataType:'json',
